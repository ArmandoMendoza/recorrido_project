...
ernesto.set_availability!(block: "#{week}615".to_i)
ernesto.set_availability!(block: "#{week}616".to_i)
ernesto.set_availability!(block: "#{week}617".to_i)
ernesto.set_availability!(block: "#{week}618".to_i)
ernesto.set_availability!(block: "#{week}619".to_i)
ernesto.set_availability!(block: "#{week}620".to_i)
ernesto.set_availability!(block: "#{week}621".to_i)
ernesto.set_availability!(block: "#{week}622".to_i)
ernesto.set_availability!(block: "#{week}623".to_i)
...
#sundat
ernesto.set_availability!(block: "#{week}710".to_i)
ernesto.set_availability!(block: "#{week}711".to_i)
ernesto.set_availability!(block: "#{week}712".to_i)
ernesto.set_availability!(block: "#{week}713".to_i)
ernesto.set_availability!(block: "#{week}714".to_i)
ernesto.set_availability!(block: "#{week}715".to_i)
ernesto.set_availability!(block: "#{week}716".to_i)
ernesto.set_availability!(block: "#{week}717".to_i)
ernesto.set_availability!(block: "#{week}718".to_i)
ernesto.set_availability!(block: "#{week}719".to_i)
ernesto.set_availability!(block: "#{week}720".to_i)
ernesto.set_availability!(block: "#{week}721".to_i)
ernesto.set_availability!(block: "#{week}722".to_i)
ernesto.set_availability!(block: "#{week}723".to_i)