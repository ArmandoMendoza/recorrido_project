...
RSpec.describe Schedule::Algorithms::OrToolAlgorithm, type: :lib do
  ...
  #     algorithm = Schedule::Algorithms::OrToolAlgorithm.new(company_specs: company_specs, users_specs: users_specs)
